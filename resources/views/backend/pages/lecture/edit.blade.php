            ...
            <div class="col-12 col-md-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="chapter_id" id="chapter_id" class="form-control">
                            ...
                            @foreach ($chapters as $chapter)
                                <option
                                    value="{{ $chapter->id }}"{{ $lesson->chapter_id == $chapter->id ? 'selected' : '' }}>
                                    {{ $chapter->title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="label" id="label" class="form-control">
                            @foreach ($labels as $label => $labelString)
                                <option value="{{ $label }}" {{ $lesson->label === $label ? 'selected' : '' }}>
                                    {{ $labelString }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        @if ($lesson->banner)
                            <a href="{{ Storage::url($lesson->banner) }}" target="_blank">
                                <img src="{{ Storage::url($lesson->banner) }}" alt="" width="50" />
                            </a>
                        @endif
                    ...
                    <div class="row">
                        <div class="col-12 col-md-9 mb-3">
                            ...
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="Enter lecture name" required value="{{ $lesson->title }}">
                        </div>
                        ...
                        <div class="col-12 col-md-12 mb-3 is-video">
                            <div class="d-flex justify-content-between">
                                <label for="video_url" class="form-label">
                                    ...
                                    @if (!empty($lesson->video_url))
                                        <a href="{{ Storage::url($lesson->video_url) }}" target="_blank">
                                            <i class="fa fa-download"></i>
                                        </a>
                                    @endif
                                </label>
                                <label>
                                    <input type="checkbox" id="is-video-checkbox"
                                        {{ !empty($lesson->video_url) ? 'checked' : '' }}>
                                    Provide Video
                                </label>
                            </div>
                            ...
                            <input type="url" name="embedded_url" id="embedded_url" class="form-control"
                                placeholder="Enter embedd URL" value="{{ $lesson->embedded_url }}">
                        </div>
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <textarea class="form-control" name="description" id="editor" rows="3">{!! $lesson->description !!}</textarea>
                        </div>
                        <div class="col-6 col-md-6 mb-3">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description" rows="2">{!! $lesson->meta_description !!}</textarea>
                        </div>
                        <div class="col-6 col-md-6 mb-3">
                            ...
                            <textarea class="form-control" name="meta_keywords" id="meta_keywords" rows="2">{!! $lesson->meta_keywords !!}</textarea>
                        </div>
                    </div>
                    <div class="mb-3">
...
@section('scripts')
    <script>
        const isVideo = parseInt("{{ !empty($lesson->video_url) ? '1' : '0' }}");
        console.log(isVideo);
        if (isVideo) {
            $("#embedded_url").hide();
        } else {
