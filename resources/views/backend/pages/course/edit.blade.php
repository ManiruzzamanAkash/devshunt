        ...
        <form action="{{ route('admin.courses.update', $course->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 mb-3">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_free" id="is_free"
                            value="1" {{ $course->is_free ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_free">Click to make it free/paid </label>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    ...
                    @if ($course->banner)
                        <a href="{{ Storage::url($course->banner) }}" target="_blank">
                            <img src="{{ Storage::url($course->banner) }}" alt="" width="50" />
                        </a>
                    @endif
                ...
                <div class="col-12 col-md-3 mb-3">
                    ...
                    <input type="number" class="form-control" name="offer_price" id="offer_price"
                        placeholder="Enter offer price" value="{{ empty($course->offer_price) ? '' : $course->offer_pric }}">
                </div>
                <div class="col-12 col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="description" id="editor" rows="3">{!! $course->description !!}</textarea>
                </div>
                <div class="col-6 col-md-6 mb-3">
                    ...
                    <textarea class="form-control" name="meta_description" id="meta_description" rows="2">{!! $course->meta_description !!}</textarea>
                </div>
                <div class="col-6 col-md-6 mb-3">
                    ...
                    <textarea class="form-control" name="meta_keywords" id="meta_keywords" rows="2">{!! $course->meta_keywords !!}</textarea>
                </div>
                <div class="col-6 col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control" name="external_enroll_link" id="external_enroll_link" value="{{ $course->external_enroll_link }}"/>
                </div>
